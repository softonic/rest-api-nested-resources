...
class EnsureModelExistsTest extends TestCase
{
     ...
     * @test
     */
    public function whenModelExistsItShouldDoNothing()
    {
     ...
     * @test
     */
    public function whenModelDoesNotExistItShouldThrowAnException()
    {
        $this->builder->shouldReceive('count')
            ->once()
            ->andReturn(0);
    ...
    public function fieldsDoesNotExistProvider(): array
    {
        return [
     ...
     */
    public function whenFieldsDoesNotExistItShouldDoNothing(array $parameters)
    {
        $result = $this->ensureModelExists->process(
            'PlatformVersion',
            ['id_platform', 'id_version=id_platformversion'],
